...
uart.init(9600, bits=8, parity=None, stop=1)#initialization
#FUNCTIONS-----------------------------------------------------------------------------------
...
while(True):
    ...
    if (x_2 == 0 and y_2 == 0):
        continue
    #make sure like when bouncing, it will not caputure two circles that are very close
